...
function(create_resources input_dir source_output header_output)
    ...
    foreach(bin ${bins})
        ...
        file(APPEND ${source_output} "static const uint8_t ${filename}[] = {${filedata}};\n")
        file(APPEND ${source_output} "static const uint8_t *${filename}Ptr = static_cast<const uint8_t *>(${filename});\n")
        file(APPEND ${source_output} "static const uint32_t ${filename}Size = sizeof(${filename});\n")
    endforeach()
    ...
    foreach(bin ${bins})
        ...
        file(APPEND ${source_output} "    { &${filename}Ptr, ${filename}Size },\n")
    endforeach()
